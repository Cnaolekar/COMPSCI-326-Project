...
import { AttributeEvent, ConditionalEvent, DirectiveEvent, DoctypeEvent, DOMReadyEvent, Event, TagCloseEvent, TagOpenEvent, WhitespaceEvent } from "../event";
...
export declare class Parser {
    ...
    private consumeTag;
    consumeAttribute(source: Source, node: HtmlElement, token: Token, next?: Token): void;
